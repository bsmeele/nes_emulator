...
CPU::CPU(Bus* bus) {
  ...
  this->x_index = 0x00;
  this->y_index = 0x00;
  this->flag = 0b00100100;  // Unsure about the state of the B flag on power-up and reset, however it shouldn't matter since the B flag is only set when pushing the flag register to the stack
